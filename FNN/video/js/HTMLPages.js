...
$(".InterestHref1").attr("href",  "../html/" + TopCategory1 + "NArticle.html#" + TS1href);
$(".InterestHref2").attr("href",  "../html/" + TopCategory2 + "NArticle.html#" + TS2href);
$(".InterestHref3").attr("href",  "../html/" + TopCategory3 + "NArticle.html#" + TS3href);
$(".InterestHref4").attr("href",  "../html/" + TopCategory4 + "NArticle.html#" + TS4href);
$(".InterestHref5").attr("href",  "../html/" + TopCategory5 + "NArticle.html#" + TS5href);